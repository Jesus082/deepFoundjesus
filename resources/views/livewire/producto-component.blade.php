        ...
        <form enctype="multipart/form-data" wire:submit.prevent="store">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10" id="categorias">
                    ...
                    <select class="form-control" name="" id="" wire:model="category" required>
                    ...
                    <select class="form-control" name="" id="" wire:model="subcategory" required>
            ...
            <div class="form group" id="anioFabricacion">
                ...
                <select class="" id="anio" name="anio" wire:model="manufacturing" required>
            ...
            <div class="form-group">
                <select class="form-control" wire:model="selectedAutonomia" required>
                ...
                @if ($selectedAutonomia)
                    ...
                    <select class="form-control" wire:model="selectedProvincia" wire:target="selectedAutonomia"
                        wire:loading.attr="hidden" required>
                ...
                @if ($selectedProvincia)
                    ...
                    <select wire:model="selectedMunicipio" class="form-control"
                        wire:target="selectedProvincia, selectedAutonomia" wire:loading.attr="hidden" required>
